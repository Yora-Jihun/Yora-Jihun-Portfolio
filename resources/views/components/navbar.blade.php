<nav class="fixed top-0 left-0 right-0 h-16 bg-white border-b border-[#EAEAEA] z-[1000]" role="navigation" aria-label="Main navigation">
    <div class="flex items-center h-full max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div class="flex-1 flex items-center justify-center h-full hidden md:flex">
            <a href="{{ url('/') }}" class="nav-link relative inline-block uppercase text-[0.6875rem] font-semibold tracking-[0.15em] text-[#8E8E93] no-underline py-2 px-7 transition-colors duration-200 whitespace-nowrap hover:text-black {{ request()->is('/') ? 'text-black active' : '' }}">About</a>
            <a href="{{ url('/projects') }}" class="nav-link relative inline-block uppercase text-[0.6875rem] font-semibold tracking-[0.15em] text-[#8E8E93] no-underline py-2 px-7 transition-colors duration-200 whitespace-nowrap hover:text-black {{ request()->is('projects') ? 'text-black active' : '' }}">Projects</a>
            <a href="{{ url('/skills') }}" class="nav-link relative inline-block uppercase text-[0.6875rem] font-semibold tracking-[0.15em] text-[#8E8E93] no-underline py-2 px-7 transition-colors duration-200 whitespace-nowrap hover:text-black {{ request()->is('skills') ? 'text-black active' : '' }}">Skills</a>
            <a href="{{ url('/experience') }}" class="nav-link relative inline-block uppercase text-[0.6875rem] font-semibold tracking-[0.15em] text-[#8E8E93] no-underline py-2 px-7 transition-colors duration-200 whitespace-nowrap hover:text-black {{ request()->is('experience') ? 'text-black active' : '' }}">Experience</a>
            <a href="{{ url('/blog') }}" class="nav-link relative inline-block uppercase text-[0.6875rem] font-semibold tracking-[0.15em] text-[#8E8E93] no-underline py-2 px-7 transition-colors duration-200 whitespace-nowrap hover:text-black {{ request()->is('blog') ? 'text-black active' : '' }}">Blog</a>
        </div>
    ...
    <div id="mobile-menu" class="md:hidden fixed inset-0 top-16 bg-white z-[999] hidden flex-col transition-opacity duration-300 opacity-0">
        ...
        <a href="{{ url('/experience') }}" class="mobile-nav-link block w-full text-center uppercase text-[0.6875rem] font-semibold tracking-[0.15em] text-[#8E8E93] no-underline py-4 border-b border-[#EAEAEA] hover:text-black transition-colors duration-200">Experience</a>
            <a href="{{ url('/blog') }}" class="mobile-nav-link block w-full text-center uppercase text-[0.6875rem] font-semibold tracking-[0.15em] text-[#8E8E93] no-underline py-4 border-b border-[#EAEAEA] hover:text-black transition-colors duration-200">Blog</a>
        <div class="p-4">
