                ...
                <form method="POST" action="{{ route('admin.posts.store') }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="bg-white border border-[#EAEAEA] rounded-xl p-6 md:p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="body" rows="12" required class="w-full px-4 py-3 rounded-lg border border-[#E5E7EB] bg-white text-sm focus:outline-none focus:border-[#16A34A] focus:ring-1 focus:ring-[#16A34A] transition-all resize-none" placeholder="Write your post content here...">{{ old('body') }}</textarea>
                        </div>
                        ...
                        <div class="flex items-center gap-4 pt-2">
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="checkbox" name="featured" value="1" {{ old('featured') ? 'checked' : '' }} class="w-4 h-4 rounded border-[#E5E7EB] text-[#16A34A] focus:ring-[#16A34A]">
